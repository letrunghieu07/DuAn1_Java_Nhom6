...
//        }
    ...
    public int updateChatLieu(ChatLieuMatGiay1 clmg, Integer ma) {
        sql = "Update CHAT_LIEU set TenChatLieu = ?,TrangThai = ? where MaCL = ?";
        try {
            con = JdbcHelper.getConnection();
            ps = con.prepareStatement(sql);
            ps.setObject(1, clmg.getTenChatLieu());
            ps.setObject(2, clmg.isTrangThai());
            ps.setObject(3, ma);
            return ps.executeUpdate();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public int updateChatLieuDe(ChatLieuDeGiay1 cldg, Integer ma) {
        sql = "Update CHAT_LIEU_DE_GIAY set TenChatLieuDe = ?, TrangThai = ? where MaCLDe = ?";
        try {
            con = JdbcHelper.getConnection();
            ps = con.prepareStatement(sql);
            ps.setObject(1, cldg.getTenChatLieuDe());
            ps.setObject(2, cldg.isTrangThai());
            ps.setObject(3, ma);
            return ps.executeUpdate();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public int updateDanhMuc(DanhMuc1 dm, Integer ma) {
        sql = "Update DANH_MUC set TenDanhMuc = ?,TrangThai = ? where MaDM = ?";
        try {
            con = JdbcHelper.getConnection();
            ps = con.prepareStatement(sql);
            ps.setObject(1, dm.getTenDanhMuc());
    ...
    public int UpdateMauSac(MauSac1 ms, Integer ma) {
        sql = "update MAU_SAC set TenMau = ?, TrangThai = ? where MaMS = ?";
        try {
            con = JdbcHelper.getConnection();
            ps = con.prepareStatement(sql);
            ps.setObject(1, ms.getTenMau());
    ...
    public int UpdateSize(Size1 sz, Integer ma) {
        sql = "Update SIZE set KichThuoc = ?, TrangThai = ? where MaSize = ?";
        try {
            con = JdbcHelper.getConnection();
            ps = con.prepareStatement(sql);
            ps.setObject(1, sz.getKichThuoc());
