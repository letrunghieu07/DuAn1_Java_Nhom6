...
public class Voucherq_1 {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        Voucherq_1 other = (Voucherq_1) obj;
        if (MaKM != other.MaKM)
            return false;
        return true;
    }

    public Voucherq_1(String tenKhuyenMai, Date ngayBD, Date ngayKT, double mucGiam, String maGiam, boolean donVi,
            boolean trangThai) {
    ...
    public Voucherq_1(int maKM, String tenKhuyenMai, Date ngayBD, Date ngayKT, double mucGiam, String maGiam,
